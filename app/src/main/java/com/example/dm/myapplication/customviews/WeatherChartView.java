...
public class WeatherChartView extends View {
     ...
     * x轴集合
     */
    private float mXAxis[] = new float[4];

    /**
     * 白天y轴集合
     */
    private float mYAxisDay[] = new float[4];

    /**
     * 夜间y轴集合
     */
    private float mYAxisNight[] = new float[4];
     ...
     * 白天温度集合
     */
    private int mTempDay[] = new int[4];

    /**
     * 夜间温度集合
     */
    private int mTempNight[] = new int[4];
