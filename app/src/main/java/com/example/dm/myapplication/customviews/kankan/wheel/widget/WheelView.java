...
package com.example.dm.myapplication.customviews.kankan.wheel.widget;
...
import com.example.dm.myapplication.customviews.kankan.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        int offset = (int) (getItemHeight() / 1.8);
