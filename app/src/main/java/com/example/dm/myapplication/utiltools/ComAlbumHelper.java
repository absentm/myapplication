...
public class ComAlbumHelper {
    ...
    private static ComAlbumHelper instance;

    private ComAlbumHelper() {
    }

    public static ComAlbumHelper getHelper() {
        if (instance == null) {
            instance = new ComAlbumHelper();
        }
        return instance;
    }
    ...
    void getAlbum() {
        String[] projection = {MediaStore.Audio.Albums._ID, Albums.ALBUM, Albums.ALBUM_ART,
