...
/**
 * FindQrScanerAty
 * Created by dm on 16-9-11.
 */
public class FindQrScanerAty extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.find_qr_scan_layout);
        ...
        scanBarCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //打开扫描界面扫描条形码或二维码
                Intent openCameraIntent = new Intent(FindQrScanerAty.this, CaptureActivity.class);
        ...
        generateQRCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!contentString.equals("")) {
                    ...
                    Toast.makeText(FindQrScanerAty.this, "Text can not be empty", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
