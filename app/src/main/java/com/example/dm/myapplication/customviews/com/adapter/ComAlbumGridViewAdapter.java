 ...
 */
public class ComAlbumGridViewAdapter extends BaseAdapter {
    ...
    public ComAlbumGridViewAdapter(Context c, ArrayList<ImageItem> dataList,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(
                    ResUtil.getLayoutID("com_post_plugin_camera_select_imageview"), parent, false);
...
//					path, ResUtil.getDrawableID("plugin_camera_camera_default"), 100, 100);
